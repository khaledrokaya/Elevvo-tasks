    ...
    <div className="space-y-6">
      ...
      <div className="mb-8">
        <div className="flex items-center mb-2 space-x-3">
          <div className="w-2 h-8 rounded-full bg-gradient-to-b from-purple-500 to-blue-500"></div>
          <h1 className="text-4xl font-bold text-transparent bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text">Overview</h1>
        </div>
        <p className="ml-5 text-lg font-medium text-gray-600">Welcome back! Here's what's happening with your projects today.</p>
      </div>

      {/* Stats Cards */}
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        <div className="relative p-8 overflow-hidden text-white l36-card l36-stat-card-purple">
          <div className="relative z-10 flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center mt-3">
                <div className="flex items-center px-2 py-1 bg-white rounded-full bg-opacity-20">
                  <i className="mr-1 text-xs fas fa-arrow-up"></i>
                  <span className="text-xs font-semibold">2 new</span>
                </div>
              </div>
            </div>
            <div className="p-4 bg-white bg-opacity-20 rounded-2xl backdrop-blur-sm">
              <i className="text-3xl fas fa-folder"></i>
            </div>
          </div>
          <div className="absolute top-0 right-0 w-32 h-32 transform translate-x-8 -translate-y-8 bg-white rounded-full opacity-5"></div>
        </div>

        <div className="relative p-8 overflow-hidden text-white l36-card l36-stat-card-green">
          <div className="relative z-10 flex items-center justify-between">
            <div>
            ...
            <div className="p-4 bg-white bg-opacity-20 rounded-2xl backdrop-blur-sm">
              <i className="text-3xl fas fa-dollar-sign"></i>
            </div>
          </div>
          <div className="absolute top-0 right-0 w-32 h-32 transform translate-x-8 -translate-y-8 bg-white rounded-full opacity-5"></div>
        </div>

        <div className="relative p-8 overflow-hidden text-white l36-card l36-stat-card-orange">
          <div className="relative z-10 flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center mt-3">
                <div className="flex items-center px-2 py-1 bg-white rounded-full bg-opacity-20">
                  <i className="mr-1 text-xs fas fa-exclamation-triangle"></i>
                  <span className="text-xs font-semibold">2 overdue</span>
                </div>
              </div>
            </div>
            <div className="p-4 bg-white bg-opacity-20 rounded-2xl backdrop-blur-sm">
              <i className="text-3xl fas fa-clock"></i>
            </div>
          </div>
          <div className="absolute top-0 right-0 w-32 h-32 transform translate-x-8 -translate-y-8 bg-white rounded-full opacity-5"></div>
        </div>

        <div className="relative p-8 overflow-hidden text-white l36-card l36-stat-card-blue">
          <div className="relative z-10 flex items-center justify-between">
            <div>
      ...
      <div className="p-8 l36-card">
        <div className="flex items-center justify-between mb-8">
          <h2 className="flex items-center text-2xl font-bold text-gray-800">
            <i className="mr-3 text-blue-500 fas fa-history"></i>
            Recent Activity
          </h2>
          <button className="px-4 py-2 text-sm font-semibold text-white transition-all duration-300 transform shadow-lg bg-gradient-to-r from-blue-500 to-purple-500 rounded-xl hover:from-blue-600 hover:to-purple-600 hover:shadow-xl hover:scale-105">
            View All
          </button>
        </div>
        ...
        <div className="space-y-4">
          {mockActivities.slice(0, 5).map((activity) => (
            <div key={activity.id} className="flex items-start p-5 space-x-4 transition-all duration-300 border border-gray-100 group bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl hover:from-white hover:to-gray-50 hover:border-gray-200 hover:shadow-md">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center mt-2">
                  <span className="px-3 py-1 text-sm text-gray-500 bg-white rounded-full shadow-sm">{formatTimeAgo(activity.timestamp)}</span>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          <button className="flex items-center p-4 space-x-4 text-white transition-all duration-300 transform group bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl hover:from-blue-600 hover:to-blue-700 hover:scale-105 hover:shadow-xl">
            <div className="p-3 transition-transform bg-white bg-opacity-20 rounded-xl group-hover:scale-110">
              <i className="text-2xl fas fa-plus-circle"></i>
            </div>
