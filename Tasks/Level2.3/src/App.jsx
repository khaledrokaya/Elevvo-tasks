...
function App() {
  ...
  return (
    <>
      <div id="home" className="header text-white py-4 h-[100vh]">
        <div className="container mx-auto px-10">
          ...
          <nav className="flex items-center justify-between">
            ...
            <div className={`!z-[9999] links ${navOpen ? 'h-[450px]' : 'h-0 !p-0'} top-16 left-0 lg:h-fit justify-between overflow-hidden absolute lg:relative bg-[var(--dark-color)] lg:bg-transparent lg:top-0 lg:items-center w-full p-4 rounded-lg flex-col flex lg:flex-row gap-8`}>
              <ul className="flex gap-8 lg:flex-row flex-col flex-1 justify-center lg:static w-full lg:w-auto lg:bg-transparent lg:p- lg:rounded-none">
              ...
              {/* Download Button */}
              <div className="download-btn lg:w-fit w-full items-center flex justify-center">
          ...
          <div className="header-content flex flex-col items-center justify-center text-center h-[80vh]">
            ...
            <p className="mt-4 lg:text-2xl text-xl">Your ultimate task management solution</p>
      ...
      <div id="features" className="features section-animate py-22 bg-[var(--primary-dark)]" ref={(el) => sectionsRef.current[0] = el}>
        <div className="container mx-auto px-10">
          <h2 className="text-4xl font-bold text-center mb-8 text-white">Why TaskFlow Stands Out</h2>
          <p className="text-center text-gray-300 mb-24">TaskFlow offers a unique blend of features designed to enhance your productivity and streamline your workflow.</p>
      ...
      <div id="reviews" className="reviews section-animate py-20 bg-[var(--dark-color)]" ref={(el) => sectionsRef.current[1] = el}>
        <div className="container mx-auto px-10">
          ...
          <p className="text-center text-gray-300 mb-16">Join thousands of satisfied users who have transformed their productivity with TaskFlow.</p>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {reviews.map((review, index) => (
              <div className="review-card bg-[var(--primary-dark)] p-8 rounded-lg shadow-lg border border-[var(--primary-light)] border-opacity-20" key={index}>
                ...
                <p className="text-gray-300 leading-6 italic">"{review.comment}"</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div id="pricing" className="pricing section-animate py-20 bg-[var(--primary-dark)]" ref={(el) => sectionsRef.current[2] = el}>
        <div className="container mx-auto px-10">
          <h2 className="text-4xl font-bold text-center mb-8 text-white">Choose Your Plan</h2>
          <p className="text-center text-gray-300 mb-16">Select the perfect plan for your needs. Upgrade or downgrade at any time.</p>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {pricingPlans.map((plan, index) => (
              <div className={`pricing-card bg-[var(--dark-color)] flex flex-col p-8 rounded-lg shadow-lg border-2 transition-all duration-300 hover:scale-105 ${plan.highlighted ? 'border-[var(--primary-color)] bg-[var(--primary-color)] bg-opacity-10' : 'border-[var(--primary-light)] border-opacity-20'}`} key={index}>
                ...
                <ul className="features-list mb-8 flex-1">
